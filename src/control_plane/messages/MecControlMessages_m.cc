...
EXECUTE_ON_STARTUP(
    ...
    e->insert(MEC_APP_TRANSFERT_MESSAGE, "MEC_APP_TRANSFERT_MESSAGE");
...
unsigned int MecControlMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_ctlMsgType
...
bool MecControlMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_ctlMsgType: pp->setCtlMsgType((ControlMessageType)string2enum(value, "ControlMessageType")); return true;
...
Register_Class(MecAppTransfertMessage)

MecAppTransfertMessage::MecAppTransfertMessage() : ::MecControlMessage()
{
    this->setChunkLength(inet::B(5*1024));
    this->setCtlMsgType(MEC_APP_TRANSFERT_MESSAGE);

}

MecAppTransfertMessage::MecAppTransfertMessage(const MecAppTransfertMessage& other) : ::MecControlMessage(other)
{
    copy(other);
}

MecAppTransfertMessage::~MecAppTransfertMessage()
{
}

MecAppTransfertMessage& MecAppTransfertMessage::operator=(const MecAppTransfertMessage& other)
{
    if (this == &other) return *this;
    ::MecControlMessage::operator=(other);
    copy(other);
...
class MecAppTransfertMessageDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    ...
    virtual ~MecAppTransfertMessageDescriptor();
...
Register_ClassDescriptor(MecAppTransfertMessageDescriptor)

MecAppTransfertMessageDescriptor::MecAppTransfertMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(MecAppTransfertMessage)), "MecControlMessage")
{
    propertynames = nullptr;
}

MecAppTransfertMessageDescriptor::~MecAppTransfertMessageDescriptor()
{
    delete[] propertynames;
}

bool MecAppTransfertMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<MecAppTransfertMessage *>(obj)!=nullptr;
}

const char **MecAppTransfertMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *MecAppTransfertMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int MecAppTransfertMessageDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int MecAppTransfertMessageDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppTransfertMessageDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int MecAppTransfertMessageDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'a' && strcmp(fieldName, "appName") == 0) return base+0;
...
const char *MecAppTransfertMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **MecAppTransfertMessageDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppTransfertMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int MecAppTransfertMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppTransfertMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string MecAppTransfertMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool MecAppTransfertMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppTransfertMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *MecAppTransfertMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
Register_Class(MecAppMigrationMessage)

MecAppMigrationMessage::MecAppMigrationMessage() : ::MecControlMessage()
{
    this->setChunkLength(inet::B(200));
    this->setCtlMsgType(MEC_APP_MIGRATION_MESSAGE);

}

MecAppMigrationMessage::MecAppMigrationMessage(const MecAppMigrationMessage& other) : ::MecControlMessage(other)
{
    copy(other);
}

MecAppMigrationMessage::~MecAppMigrationMessage()
{
}

MecAppMigrationMessage& MecAppMigrationMessage::operator=(const MecAppMigrationMessage& other)
{
    if (this == &other) return *this;
    ::MecControlMessage::operator=(other);
    copy(other);
...
{
    return this->dest.c_str();
}

void MecAppMigrationMessage::setDest(const char * dest)
{
    handleChange();
    this->dest = dest;
}

class MecAppMigrationMessageDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
    enum FieldConstants {
  ...
  public:
    MecAppMigrationMessageDescriptor();
    virtual ~MecAppMigrationMessageDescriptor();
...
Register_ClassDescriptor(MecAppMigrationMessageDescriptor)

MecAppMigrationMessageDescriptor::MecAppMigrationMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(MecAppMigrationMessage)), "MecControlMessage")
{
    propertynames = nullptr;
}

MecAppMigrationMessageDescriptor::~MecAppMigrationMessageDescriptor()
{
    delete[] propertynames;
}

bool MecAppMigrationMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<MecAppMigrationMessage *>(obj)!=nullptr;
}

const char **MecAppMigrationMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *MecAppMigrationMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int MecAppMigrationMessageDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 2+basedesc->getFieldCount() : 2;
}

unsigned int MecAppMigrationMessageDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppMigrationMessageDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int MecAppMigrationMessageDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'a' && strcmp(fieldName, "appName") == 0) return base+0;
...
const char *MecAppMigrationMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **MecAppMigrationMessageDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppMigrationMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int MecAppMigrationMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppMigrationMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string MecAppMigrationMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool MecAppMigrationMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MecAppMigrationMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *MecAppMigrationMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
